                ...
                if (isDroneClearingPrebuild(prebuild))
                {
                    for (int activeMissionIdx = 0; activeMissionIdx < activeMissions.Count; ++activeMissionIdx)
                    {
                        ...
                        if (missionData.prebuildId == prebuildId)
                        {
                            ...
                            {
                                __instance.position = GameMain.mainPlayer.position.normalized * (GameMain.mainPlayer.position.magnitude + 3.8f);
                            ...
                            {
                                __instance.position = GameMain.mainPlayer.position.normalized * (GameMain.mainPlayer.position.magnitude - 1.0f);
                            }
                        }
                    }
                    __result = 0;
